...
#    print("Initial path value: {:.2f}".format(tsp.fitness()))
#
#    for j in range(100):
#        print(j)
...
#        ga.append(population.mostFitIndividual())
    #fig = plt.figure()
...
#    
    ...
    show_path(pstar.coords, starting_city, w=4, h=3)
    ...
    plt.hist([x.fitness() for x in ga])
    plt.title("Genetic with pop=1000, cycles=200")
    plt.xlabel("Value")
